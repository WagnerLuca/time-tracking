...
namespace TimeTracking.Api.Migrations
{
    ...
    [Migration("20260418180958_AddAbsenceVisibilitySettings")]
    partial class AddAbsenceVisibilitySettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTracking.Api.Models.AbsenceDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TimeTracking.Api.Models.Holiday", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TimeTracking.Api.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TimeTracking.Api.Models.Organization", b =>
                {
                    ...
                    b.Property<int>("CsvImportMode")
                        .HasColumnType("integer");

                    b.Property<double>("DefaultVacationDays")
                    ...
                    b.Property<bool>("MemberTimeEntryVisibility")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("SickDayVisibility")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("VacationVisibility")
                        .HasColumnType("integer");

                    b.Property<string>("Website")
                        .HasColumnType("text");

                    b.Property<int>("WorkScheduleChangeMode")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TimeTracking.Api.Models.WorkSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "OrganizationId", "ValidFrom")
                        .IsUnique();
