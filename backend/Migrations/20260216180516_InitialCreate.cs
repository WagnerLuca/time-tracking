        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowEditPastEntries = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinHours = table.Column<double>(type: "double precision", nullable: false),
                    PauseMinutes = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PauseRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PauseRules_Organizations_OrganizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PauseRules_OrganizationId_MinHours",
                table: "PauseRules",
                columns: new[] { "OrganizationId", "MinHours" },
                unique: true);
